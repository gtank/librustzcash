...
mod tests {
    ...
    fn create_account() {
        let mut wallet = Wallet::new(
            ...
            Box::new(ChainManager::new("127.0.0.1:0".parse().unwrap())),
    ...
    fn balance() {
        ...
        wallet.create_account("test1".to_owned());
        wallet.create_account("test2".to_owned());
    ...
    fn make_payment() {
        ...
        let mut wallet = Wallet::new(
            ...
            Box::new(LocalTxProver::new(
                "/mnt/c/Users/me/AppData/Roaming/ZcashParams/sapling-spend.params",
                "8270785a1a0d0bc77196f000ee6d221c9c9894f55307bd9357c3f0105d31ca63991ab91324160d8f53e2bbd3c2633a6eb8bdf5205d822e7f3f73edac51b2b70c",
                "/mnt/c/Users/me/AppData/Roaming/ZcashParams/sapling-output.params",
